...
$('[name="Fastback"]').click(function() {
    ...
    // $(".color-gradient").click(function(){
    //       // action goes here!!

    //       car.colour = $(this).attr("name");


    //       var total = model+folder+style+"-"+colour+stripe+spoiler+front;
